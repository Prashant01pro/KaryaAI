            ...
            <header className="fixed top-0 right-0 left-0 h-20 px-8 flex justify-between items-center bg-white/70 backdrop-blur-xl border-b border-surface-container-high/50 z-40 transition-all">
                ...
                <div className="flex items-center gap-6">
                    ...
                    <motion.div
                        ...
                        className="flex items-center gap-4 group cursor-pointer bg-surface-container-low px-4 py-2 rounded-2xl hover:bg-surface-container transition-all"
                    >
                        ...
                        <div className="w-10 h-10 ai-gradient rounded-xl flex items-center justify-center text-white font-black shadow-lg shadow-primary/10">
